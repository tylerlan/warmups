...
function conferencePicker (citiesVisited, citiesOffered) {
  let citiesLucyCanGoTo = citiesOffered.filter( (city) => !citiesVisited.includes(city) );
  return citiesLucyCanGoTo.length > 0 ? citiesLucyCanGoTo[0] : "No worthwhile conferences this year!";
}
